...
//        }
        ...
        okHttpRequestBuilder.addHeader("User-Agent", System.getProperty("http.agent"));//默认直接获取系统的，如果需要修改请注释掉本行，然后在UmiwiApplication里修改
        ...
        for (int i = 0, len = responseHeaders.size(); i < len; i++) {
            ...
            if (name != null) {
                response.addHeader(new BasicHeader(name + "_" + i, value));
            }
        }

//        for (Map.Entry<String, List<String>> header : okHttpResponse.headers().toMultimap().entrySet()) {
//
