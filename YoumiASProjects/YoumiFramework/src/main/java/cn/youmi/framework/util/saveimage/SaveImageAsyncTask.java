package cn.youmi.framework.util.saveimage;
...
public abstract class SaveImageAsyncTask<Params, Progress, Result> {
     ...
     */
    public final SaveImageAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     *                               {@link AsyncTask.Status#RUNNING} or {@link AsyncTask.Status#FINISHED}.
     */
    public final SaveImageAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        ...
        final SaveImageAsyncTask mTask;

        final Data[] mData;

        AsyncTaskResult(SaveImageAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
