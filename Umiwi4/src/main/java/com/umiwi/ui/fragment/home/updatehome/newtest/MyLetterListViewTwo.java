...
//import com.umiwi.ui.fragment.ExpertFragment;
//import com.umiwi.ui.fragment.ExpertFragment.LastnameHandler;
...
public class MyLetterListViewTwo extends View {
	...
	public MyLetterListViewTwo(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public MyLetterListViewTwo(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public MyLetterListViewTwo(Context context) {
		super(context);
	}
	...
	public boolean dispatchTouchEvent(MotionEvent event) {
		...
		switch (action) {
			...
			case MotionEvent.ACTION_MOVE:
				if(b != null && oldChoose != c && listener != null){
					if(c >= 0 && c< b.size()){
						...
						if(lastnameHandler != null) {
							Message msgLastnameMove = lastnameHandler.obtainMessage(ExpertFragment.POP_MOVE);
			...
			case MotionEvent.ACTION_UP:
				showBkg = false;
				Message msgDismissLastname = lastnameHandler.obtainMessage(ExpertFragment.POP_DISMISS);
