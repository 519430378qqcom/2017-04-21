...
public class BuyCoumnBean {
    ...
    private BuyCoumnBean.PageBean page;
    private List<BuyCoumnBean.RecordBean> record;

    public BuyCoumnBean.PageBean getPage() {
        return page;
    }

    public void setPage(BuyCoumnBean.PageBean page) {
        this.page = page;
    }

    public List<BuyCoumnBean.RecordBean> getRecord() {
        return record;
    }

    public void setRecord(List<BuyCoumnBean.RecordBean> record) {
        this.record = record;
    }
