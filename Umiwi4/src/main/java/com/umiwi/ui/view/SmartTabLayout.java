...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.ogaclejapan.smarttablayout.R.styleable.stl_SmartTabLayout, defStyle, 0);
        tabBackgroundResId = a.getResourceId(com.ogaclejapan.smarttablayout.R.styleable.stl_SmartTabLayout_stl_defaultTabBackground, tabBackgroundResId);
        textAllCaps = a.getBoolean(com.ogaclejapan.smarttablayout.R.styleable.stl_SmartTabLayout_stl_defaultTabTextAllCaps, textAllCaps);
        textColors = a.getColorStateList(com.ogaclejapan.smarttablayout.R.styleable.stl_SmartTabLayout_stl_defaultTabTextColor);
        textSize = a.getDimension(com.ogaclejapan.smarttablayout.R.styleable.stl_SmartTabLayout_stl_defaultTabTextSize, textSize);
        textHorizontalPadding = a.getDimensionPixelSize(com.ogaclejapan.smarttablayout.R.styleable.stl_SmartTabLayout_stl_defaultTabTextHorizontalPadding, textHorizontalPadding);
        textMinWidth = a.getDimensionPixelSize(com.ogaclejapan.smarttablayout.R.styleable.stl_SmartTabLayout_stl_defaultTabTextMinWidth, textMinWidth);
        customTabLayoutId = a.getResourceId(com.ogaclejapan.smarttablayout.R.styleable.stl_SmartTabLayout_stl_customTabTextLayoutId, customTabLayoutId);
        customTabTextViewId = a.getResourceId(com.ogaclejapan.smarttablayout.R.styleable.stl_SmartTabLayout_stl_customTabTextViewId, customTabTextViewId);
        distributeEvenly = a.getBoolean(com.ogaclejapan.smarttablayout.R.styleable.stl_SmartTabLayout_stl_distributeEvenly, distributeEvenly);
        a.recycle();
     ...
     */
    public void setViewPager(ViewPager viewPager, OnTabClickCallback onTabClickCallback) {
        ...
        public void onClick(View v) {
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                if (v == mTabStrip.getChildAt(i)) {
                    mOnTabClickCallback.onTabClick(i);
                    return;
                }
            }
        }
    ...
    public OnTabClickCallback mOnTabClickCallback;
