...
public class RoundButton extends ImageView {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			color = a.getColor(R.styleable.RoundButton_cb_color, color);
			pressedRingWidth = (int) a.getDimension(R.styleable.RoundButton_cb_pressed_ring_width, pressedRingWidth);
			a.recycle();
		}
