...
public class BottomLunboAdapter extends PagerAdapter {
    ...
    public BottomLunboAdapter(Context context, ArrayList<RecommendBean.RBean.BottomBean> arrayList) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        final RecommendBean.RBean.BottomBean listBeans = (RecommendBean.RBean.BottomBean) getItem(position % data.size());
